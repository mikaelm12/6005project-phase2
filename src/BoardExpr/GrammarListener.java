...
public interface GrammarListener extends ParseTreeListener {
	...
	void enterOtherBoard(GrammarParser.OtherBoardContext ctx);
	void exitOtherBoard(GrammarParser.OtherBoardContext ctx);

	void enterAction(GrammarParser.ActionContext ctx);
	void exitAction(GrammarParser.ActionContext ctx);

	void enterKey(GrammarParser.KeyContext ctx);
	void exitKey(GrammarParser.KeyContext ctx);
	...
	void enterOtherPortal(GrammarParser.OtherPortalContext ctx);
	void exitOtherPortal(GrammarParser.OtherPortalContext ctx);
	...
	void enterKeys(GrammarParser.KeysContext ctx);
	void exitKeys(GrammarParser.KeysContext ctx);

	void enterPortal(GrammarParser.PortalContext ctx);
	void exitPortal(GrammarParser.PortalContext ctx);
	...
	void enterKeyCmd(GrammarParser.KeyCmdContext ctx);
	void exitKeyCmd(GrammarParser.KeyCmdContext ctx);
